...
public class DataBase {
    ...
    public static final List<StudentGroup> groupDB = new ArrayList<>();

    public static final List<Stream> streamDB = new ArrayList<>();
    ...
    public static void fillDB() {
        ...
        studentsDB.add(s1);
        studentsDB.add(s2);
        StudentGroup studentGroups = new StudentGroup(1, teacher, studentsDB);
        groupDB.add(studentGroups);
        Stream stream = new Stream(groupDB);
        streamDB.add(stream);
    }
}
